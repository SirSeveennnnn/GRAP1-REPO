...
void Skybox::Draw(GLuint ShaderProgram, bool perspective, PerspectiveCamera perspectiveCamera, OrthoCamera orthoCamera, Light light)
{
    ...
    else if (!perspective)
    {
        ...
        unsigned int skyboxProjLoc = glGetUniformLocation(ShaderProgram, "projection");
        glUniformMatrix4fv(skyboxProjLoc, 1, GL_FALSE, glm::value_ptr(orthoCamera.GetOrthoProjection()));
    }
